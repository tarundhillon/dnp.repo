...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "dnp_digital" because\n';
  ...
  $wnd.__gwt_activeModules['dnp_digital'] = {
    'moduleName' : 'dnp_digital',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/dnp_digital.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['dnp_digital'].superdevmode = true;

  var expectedSuffix = '/dnp_digital.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + dnp_digital + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:dnp_digital';
  var devModeSessionKey = '__gwtDevModeSession:dnp_digital';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/dnp_digital/dnp_digital.nocache.js';
  ...
  $wnd.__gwt_activeModules['dnp_digital'].canRedirect = true;
  $wnd.__gwt_activeModules['dnp_digital'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/dnp_digital?user.agent=' + ua + '&_callback=' + callback;
