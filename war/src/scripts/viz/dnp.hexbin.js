...
//define('hexbin',['d3hexbin'],function(d3hexbin){
  define('hexbin',['d3hexbin'],function(d3hexbin){
//   	//d3 = requirejs(['d3']);
// // requirejs(['d3','d3hexbin'],function(d3,d3hexbin){

//   //requirejs(["d3"],function(ignore){
//      //console.log('loading dnp.hexbin.js ='+ignore.version);
//      console.log('loading dnp.hexbin.js ='+d3.version);
//   });
      
    console.log('loading dnp.hexbin.js');
    $('#hexbinLoader').hide();
