define('reqmgt',['moment','dnpHelper','semanticui'],
	function(moment, _help,semui){
	console.log('requirements management dependencies loaded');



	function makeFunctionMap(reqData,reqSetting){
		var html="<div class='ui "+_help.numWord[reqData.keys0.length]+" column grid funcMap stackable'>";
	...
	function makeProgressOverview(reqData,reqSetting){
		var html="<table class='ui "+_help.numWord[reqData.keys0.length+2]+" column small red compact celled table progOver stackable'>";
		html+="<thead><tr>";
...
// --- Sun brust 
	...
	var dim = _help.getDimention(reqSetting.sunBurst,200,450);
	...
	return {
		makeSunBurst: makeSunBurst,
		makeProgressOverview: makeProgressOverview,
		makeFunctionMap: makeFunctionMap
